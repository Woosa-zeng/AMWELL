  ...
  <div class="second-hand">
    ...
    <section class="car-des">
      ...
      <div class="price-ct">
        ...
        <div class="look-car-btn" @click="showApplyBox">新车代购</div>
      </div>
    </section>
    ...
    <div v-transfer-dom>
      <x-dialog :show.sync="applyBox" class="dialog-demo">
        <div class="input-box">
          ...
          <div class="apply-btn" @click="postMsg">新车代购</div>
        </div>
        <div @click="close">
...
<script type="text/ecmascript-6">
  ...
  export default{
    ...
    methods: {
      ...
      postMsg() {
        axios.post('/publicCar/addCarNewApply', qs.stringify({
      ...
      getBaseInfo() {
        axios.post('/publicCar/carNewByid', qs.stringify({
      ...
      getImgInfo() {
        axios.post('/publicCar/queryInfoById', qs.stringify({
          id: this.$store.state.currentDetailId
        })).then(res => {
          let list = []
