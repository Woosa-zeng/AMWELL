<template>
  <div id="login" @keydown.enter="keyDownLogin">
    <div class="login-bg">
      <div class="logo"></div>
        ...
        <div class="login-box" id="login-box">
          ...
          <el-form :model="ruleForm2" ref="ruleForm2" label-width="55px" class="demo-ruleForm">
            ...
            <div class="input-wrap">
              ...
              <input type="text" v-model="ruleForm2.code" placeholder="验证码" class="input code" @blur="validateCode" maxlength="4">
      ...
      submitForm(formName) {
        ...
        axios.post('/login', qs.stringify({
          ...
          if (!data.success) {
            ...
            window.localStorage.setItem('adminType', data.obj.adminType)
            this.$store.commit('LOGIN_FLAG', {loginFlag: true})
            this.$store.commit('ROUTE_CHANGE', {activeRoute: 'home/firstpage'})
            this.$store.commit('USER_NAME', {userName: userName})
...
<style lang="less" rel="stylesheet/less">
  ...
  .user-icon{
    background: url(user_icon.png) 0 0 no-repeat;
  }
  .password-icon{
